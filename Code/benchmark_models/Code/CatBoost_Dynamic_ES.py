...
def train_and_predict_catboost(X_train, y_train, X_val, y_val, X_test, quantile_alpha):
...
def run_quantile_regression_rolling_window(file_path, sheet_name, date_column, target_column, feature_columns):
    ...
    for i in range(window_size, len(df) - prediction_horizon + 1, 1):
        ...
        # Train-val split (no shuffling for time series) within the window
        ...
        # Parallel prediction using the Pool objects
        window_predictions = {'Date': date_current, f'True {target_column}': true_value}
        predictions = Parallel(n_jobs=-1)(
            delayed(train_and_predict_catboost)(X_train, y_train, X_val, y_val, X_test, q) for q in quantiles
            #delayed(train_and_predict_catboost)(train_pool, val_pool, X_test, q) for q in quantiles
        )
    ...
    output_path = f"{feature_columns_str}_ES_VaR_catboost.xlsx"
...
for features in feature_combinations:
  ...
  output_filename = f"{filename_prefix}_ES_VaR_catboost.xlsx"
...
file_pathtest = '/content/IV_Slope_ES_VaR_catboost.xlsx' # Input file
...
outputname = '/content/IV_Slope_ES_VaR_CROSS_catboost.xlsx' # Output file

temp_data.to_excel(outputname, index=False)
run_models.append(outputname)

#/content/IV_ES_VaR_catboost.xlsx
#/content/IV_IK_ES_VaR_catboost.xlsx
#/content/IV_IK_Slope_ES_VaR_catboost.xlsx
#/content/IV_IS_ES_VaR_catboost.xlsx
#/content/IV_IS_IK_ES_VaR_catboost.xlsx
#/content/IV_IS_IK_Slope_ES_VaR_catboost.xlsx
#/content/IV_IS_Slope_ES_VaR_catboost.xlsx
#/content/IV_Slope_ES_VaR_catboost.xlsx

#/content/IV_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IK_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IK_Slope_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IS_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IS_IK_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IS_IK_Slope_ES_VaR_CROSS_catboost.xlsx
#/content/IV_IS_Slope_ES_VaR_CROSS_catboost.xlsx
#/content/IV_Slope_ES_VaR_CROSS_catboost.xlsx
...
#files.download('IV_IS_IK_Slope_ES_VaR_catboost.xlsx')
#files.download('IV_IS_IK_Slope_ES_VaR_CROSS_catboost.xlsx')
files.download('IV_IS_IK_Slope_ES_catboost.xlsx')

#/content/IV_ES_catboost.xlsx
#/content/IV_IK_ES_catboost.xlsx
#/content/IV_IK_Slope_ES_catboost.xlsx
#/content/IV_IS_ES_catboost.xlsx
#/content/IV_IS_IK_ES_catboost.xlsx
#/content/IV_IS_IK_Slope_ES_catboost.xlsx
#/content/IV_IS_Slope_ES_catboost.xlsx
#/content/IV_Slope_ES_catboost.xlsx
