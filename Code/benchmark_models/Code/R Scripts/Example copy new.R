...
library(openxlsx)
#DT <- read.xlsx("/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/old_cleaned_data2.xlsx")

DT <- read.xlsx("/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/BRENT Input Eviews.xlsx")
print(colnames(DT))
...
Sys.time()-A
D = D$data
write.xlsx(D, file = "/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/Agarch_BRENT_Test.xlsx")
...
Sys.time()-A
D = D$data
write.xlsx(D, file = "/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/QuantileHAR_WTI.xlsx")

#################################################
# Dimitriadis and Bayer model - this will take a while longer (47minutes on 16 cores)
A = Sys.time()
filePath_DB <- "/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/DB_WTI_FINAL.xlsx"
D = DB(dt = DT, EW = 1500, ES = ES, nc = 24,run_all_variations = FALSE, writefile = filePath_DB)
Sys.time()-A
D = D$data
#write.xlsx(D, file = "/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/testFinalDB.xlsx")
...
#write.xlsx(D, file = "/Users/hansmagnusutne/Library/Mobile Documents/com~apple~CloudDocs/Documents/Dokumenter – Hanss MacBook Air/NTNU Dokumenter/Indøk 5. klasse/Forskningsassistent/testing.xlsx")
